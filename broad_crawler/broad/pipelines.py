...
from broad.util.transportNTLM import TransportNTLM
...
class MongoDBPipeline(object):
    ...
    def __init__(self):
        # self.client = pymongo.MongoClient("mongodb://chesian:chesian@ngrok.eailab.cn:51014")
        self.client = pymongo.MongoClient("192.168.5.203", 27017)
